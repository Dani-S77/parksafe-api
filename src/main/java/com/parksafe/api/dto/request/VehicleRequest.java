...
public class VehicleRequest {
  ...
  @Pattern(regexp = "", message = "the Brand must have colombian format: 3 letters uppercase and 3 digits(Example: ABC123)")
  ...
  @Pattern(regexp = "", message = "the phone must have exactly 10 digits")
